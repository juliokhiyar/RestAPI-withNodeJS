...
let data = [
    { id: 1, Name: 'Es Teh Tawar',  order: 1, completed: true, orderedOn: new Date() },
    { id: 2, Name: 'Kopi Arabica',     order: 2, completed: true, orderedOn: new Date() },
    { id: 3, Name: 'Teh Tarik', order: 3, completed: true, orderedOn: new Date() },
    { id: 4, Name: 'Pop Ice ', order: 4, completed: false, orderedOn: new Date() },
    { id: 5, Name: 'Es Campur', order: 5, completed: false, orderedOn: new Date() },
];
